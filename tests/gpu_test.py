...
class TestGPU:
    ...
    def test_single_layer_network_on_gpu_device() -> None:
        ...
        results = summary(model, input_size=(1, 2), device=torch.device("cuda"))
    ...
    def test_input_size_half_precision() -> None:
        ...
        with pytest.warns(
            ...
            summary(
                ...
                input_size=(10, 2), device=torch.device("cuda"),
            )
    ...
    def test_device() -> None:
        ...
        # input_size
        summary(
            model, input_size=(5, 1, 28, 28), device="cuda"  # type: ignore[arg-type]
        )
        ...
        summary(model, input_data=input_data, device="cuda")  # type: ignore[arg-type]
